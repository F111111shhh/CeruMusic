...
const steps = ref<GuideStep[]>([
  {
    ...
    title: 'Ceru Music 维护版说明',
    body: '原项目出于技术学习与研究目的开发，并以免费、开源、纯净为原则。当前版本是基于原项目继续维护的非官方版本，旨在延续项目的日常维护与可用性，不代表原作者或任何第三方平台的立场。本项目及维护者不提供、托管或授权任何音乐内容；用户应自行确认所使用的插件、数据来源及相关行为合法合规，并承担相应责任。请自行备份重要数据。本软件按现状提供，不对第三方服务的可用性、数据安全或使用后果作出保证。',
    mode: 'dialog'
  }
] as GuideStep[])
function checkGuide() {
